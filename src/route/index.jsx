...
// Elites
import lifestyle from "../components/plans/lifestyle"
import LifestyleCreate from "../components/plans/lifestyleCreate"
import PlansCreate from "../components/plans/plansCreate"
import plans from "../components/plans/plans"
import recipes from "../components/meals/recipes"
import ingredients from "../components/meals/ingredients"
import RecipesCreate from "../components/meals/recipesCreate"
import IngredientsCreate from "../components/meals/ingredientsCreate"
import WeeklySelections from "../components/weeklyselections"
import Orders from "../components/orders"
import Reviews from "../components/reviews"
import Tips from "../components/tips"
import Users from "../components/users"
import Comments from "../components/comments"
import Articles from "../components/publish/articles"
import ArticlesCreate from "../components/publish/articlesCreate"
import OrdersDashboard from "../components/orders/dashboard"
import Discounts from "../components/settings/discounts"
import ElitesPoints from "../components/settings/elitespoints"
...
export const routes = [
        ...
        { path:"/app/plans/lifestyle", Component:lifestyle},
        { path:"/app/plans/lifestyleCreate", Component:LifestyleCreate},
        { path:"/app/plans/plans", Component:plans},
        { path:"/app/meals/recipes", Component:recipes},
        { path:"/app/meals/ingredients", Component:ingredients},
        { path:"/app/weeklyselections", Component:WeeklySelections},
        { path:"/app/orders", Component:Orders},
        { path:"/app/orders/dashboard", Component:OrdersDashboard},
        { path:"/app/meals/recipesCreate", Component:RecipesCreate},
        { path:"/app/articles/articlesCreate", Component:ArticlesCreate},
        { path:"/app/articles", Component:Articles},
        { path:"/app/reviews", Component:Reviews},
        { path:"/app/tips", Component:Tips},
        { path:"/app/users", Component:Users},
        { path:"/app/comments", Component:Comments},
        { path:"/app/settings/payment", Component:Payment},
        { path:"/app/settings/general", Component:General},
        { path:"/app/settings/discounts", Component:Discounts},
        { path:"/app/settings/elitespoints", Component:ElitesPoints},
