    ...
    menutitle:"Elites Chef",
...

        {
                title: 'Meals', icon: Cloud, type: 'sub', children: [
                    ...
                    {
                        title: 'Create a Recipe', path: `${process.env.PUBLIC_URL}/app/meals/recipesCreate`, type: 'link', title: 'Create Recipes' },
                    {
            ...
            },
        {
                title: 'Publish', icon: Server, type: 'sub', children: [
                    ...
                    {
                        title: 'View Articles', path: `${process.env.PUBLIC_URL}/app/articles`, type: 'link', title: 'Articles' },
                    {
                        title: 'Create a Article', path: `${process.env.PUBLIC_URL}/app/articles/articleCreate`, type: 'link', title: 'Create an Article' },
                    {
