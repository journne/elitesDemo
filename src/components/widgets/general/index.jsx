...
import {MarkJecno,Manager,DeliveryAddress,ElitesPoints,NewOrder,Facebooks,Twitters,GooglePlus,Linkedins,Daily,Month,Week,Details,Quantity,Status,Price,Employee_Status,Designation,SkillLevel,Experience,ContactUs,YourName,Email,Name,Message,SEND_IT,Sale,Today,kolkata_India,India_Surat,RecentActivity,Profit,Loss,Post,ProductsCart,Like,Year} from "../../../constant";
            ...
            <Card className="social-widget-card">
              <CardBody>
                ...
                <Row>
                  ...
                  <Col className="text-center"><span>{Email}</span>
                    <h4 className="counter mb-0">
                      <CountUp end={75269} />
                    </h4>
                  </Col>
